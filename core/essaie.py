...
def get_alphas(step, fixed = False):
    if fixed:
        return{16:0,64:0.1,512:0.9}
...
model = G
#MTCNN
img = utils.load_img_tensor("data/48.png", device, size = 1024).unsqueeze(0)  # (1,3,512,512)
